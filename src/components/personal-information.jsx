...
const Information = () => {
    ...
    const handleDownloadCV = () =>{
        <a href="https://drive.google.com/file/d/1MdbpBUEYw2YDEqAp_D1sWCvCgdrJqPY9/view?usp=sharing" target="_blank"></a>
    }
    ...
    return (
        <div className="flex flex-row  px-[50px] min-[768px]:px-[120px] bg-[#F5ebee] ">
            <div className="flex flex-col flex-warp items-start mt-[3rem]  px-[50px] min-[768px]:px-[120px] bg-[#F5ebee] ">
                ...
                <div className="flex flex-row  items-center pr-[5rem] flex-wrap 5-[50px] mt-[2rem] mb-[2rem]  bg-[#F5ebee]">
                    ...
                    <a href="https://github.com/KraiyosW" rel="noopener noreferrer" target="_blank">
                        <button>
                            <img className="w-[50px] h-[50px] mr-[1rem]" src="/Picture/github.png"></img>
                        </button>
                    </a>
                    <a href="https://www.linkedin.com/in/kraiyos-wanna/" rel="noopener noreferrer" target="_blank" >
                        <button>
                            <img className="w-[45px] h-[40px] mr-[1rem] " src="/Picture/linkin.png"></img>
                        </button>
                    </a>
                    <button onClick={handleClickEmail}>
                        <img className="w-[45px] h-[50px] pb-[0.4rem] mr-[1rem]" src='/Picture/email.png'></img>
                    </button>
                ...
                <div className=" flex flex-row mr-[3rem]  ">
                        ...
                        <a href="https://drive.google.com/file/d/1MdbpBUEYw2YDEqAp_D1sWCvCgdrJqPY9/view?usp=sharing" target="_blank">
                            <button onClick={handleDownloadCV} className="w-[220px] h-[50px]  border-double bg-[#FFFFFF] rounded-[5px] border-4 border-sky-500 text-[#848584] text-[1.5rem] hover:border-[#25be30]" id='font1'>Download CV</button>
                    </a>
                    </div>
            </div>
            <div className="class-picture-profile">
                ...
                <img className="w-[150rem] mt-[10rem] top-[5.5rem] left-[2rem]" id="bullet2" src='/public/Picture/Bullet Points1.png'></img>
                <img className="w-[120rem] mt-[15rem] right-[8rem] " id='picture-profile' src='/public/Picture/toeyprofile.jpg'></img>
